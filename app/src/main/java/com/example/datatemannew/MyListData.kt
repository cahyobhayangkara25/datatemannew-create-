...
import com.example.datatemannew.databinding.ActivityMyListDataBinding
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        adapter = RecycleViewAdapter(dataTeman, this@MyListData)
                        recyclerView?.adapter = adapter
                        (adapter as RecycleViewAdapter).notifyDataSetChanged()
